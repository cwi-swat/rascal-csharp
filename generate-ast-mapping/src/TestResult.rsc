...
data AttributedNode = enumMemberDeclaration(str name, Expression initializer, list[AstNode] modifierTokens, list[Modifiers] modifiers, str name)
  ...
  |  constructorDeclaration(str name, Statement body, AstNode \initializer2, list[AstNode] modifierTokens, list[Modifiers] modifiers, str name, list[AstNode] parameters)
