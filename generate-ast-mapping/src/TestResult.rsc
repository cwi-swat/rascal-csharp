...
data AttributedNode = enumMemberDeclaration(str name, list[AstNode] attributes, Expression initializer, list[AstNode] modifierTokens, list[Modifiers] modifiers)
  ...
  |  typeDeclaration(str name, list[AstNode] attributes, list[AstType] baseTypes, ClassType classType, list[AstNode] constraints, list[AttributedNode] members, list[AstNode] modifierTokens, list[Modifiers] modifiers, list[AstNode] typeParameters)
...
data MemberDeclaration = indexerDeclaration(str name, list[AstNode] attributes, AttributedNode getter, list[AstNode] modifierTokens, list[Modifiers] modifiers, list[AstNode] parameters, AttributedNode setter)
  ...
  |  operatorDeclaration(str name, list[AstNode] attributes, Statement body, list[AstNode] modifierTokens, list[Modifiers] modifiers, OperatorType operatorType, list[AstNode] parameters)
...
data AssignmentOperatorType = assignmentOperatorTypeShiftLeft()
  |  assignmentOperatorTypeDivide()
  |  assignmentOperatorTypeAssign()
  |  assignmentOperatorTypeBitwiseOr()
  |  assignmentOperatorTypeAdd()
  |  assignmentOperatorTypeExclusiveOr()
  |  assignmentOperatorTypeShiftRight()
  |  assignmentOperatorTypeMultiply()
  |  assignmentOperatorTypeAny()
  |  assignmentOperatorTypeBitwiseAnd()
  |  assignmentOperatorTypeModulus()
  |  assignmentOperatorTypeSubtract();
